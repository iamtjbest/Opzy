...
const allTypes = ["Jobs", "Internships", "Scholarships", "Fellowships", "Grants", "Hackathons", "Competitions"];

export default function Onboarding() {
  const [selected, setSelected] = useState(["Jobs", "Internships", "Hackathons"]);
