    ...
    <div className="flex w-full flex-col min-h-screen bg-white">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pt-32 pb-16">
        <div className="max-w-2xl text-center">
          <h1 className="text-4xl font-extrabold text-primary-navy mb-6">Pricing</h1>
          <div className="text-lg text-neutral-ink leading-relaxed space-y-4 mb-10">
            <p>Opzy is free during early access. No card required, no catch.</p>
            <p>As the product grows, a paid tier is likely for people who want deeper personalization and unlimited tracking, but nothing is locked in yet, and nothing here will change without fair notice to people already using it.</p>
          </div>
